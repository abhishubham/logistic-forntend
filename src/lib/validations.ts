...
export const createCitySchema = z.object({
  ...
  country_id: z.number().positive('Country ID must be a positive number'),
});

export const createPortAirportSchema = z.object({
  port_name: z.string().min(2, 'Port/Airport name must be at least 2 characters'),
  port_code: z.string().min(2, 'Port/Airport code must be at least 2 characters'),
